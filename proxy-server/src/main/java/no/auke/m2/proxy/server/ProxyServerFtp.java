...
public class ProxyServerFtp extends ProxyServer {
    ...
    public ProxyServerFtp(ProxyMain mainService,
                          String serverId,
                          String bootAddress,
                          int port,
        ...
        super(mainService,serverId,bootAddress,port,inActiveTimeSeconds,corePooSize,maximumPoolSize,keepAliveTime, TypeServer.FTP);
    }
